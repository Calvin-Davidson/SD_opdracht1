...
std::string Student::GetPostcode()
{
...
{
    return this->_firstContactName;
}

std::string Student::GetFirstContactFamilyName()
{
    return this->_firstContactFamilyName;
}

int Student::GetFirstContactPhonenumber()
{
    return this->_phoneNumberfirstContact;
}
...
void Student::SetFamiltyName(std::string famililyName)
{
    this->_familyName = famililyName;
}

void Student::SetBirthDate(Date date)
{
...
void Student::SetPostcode(std::string postcode)
{
    this->_postCode = postcode;
}
...
void Student::SetFirstContactName(std::string name)
{
    this->_firstContactName = name;
}

void Student::SetFirstContactFamilyName(std::string name)
{
    this->_firstContactFamilyName = name;
}

void Student::SetFirstContactPhonenumber(int number)
{
    this->_phoneNumberfirstContact = number;
}

void Student::SetCourseYear(int year)
{
    this->_courseYear = year;
}

void Student::SetAdmissionDate(Date date)
{
